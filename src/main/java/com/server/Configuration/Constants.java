...
public class Constants {
  ...
  private final static double THRUST_MAX_SPEED = 8.0;
  public final static double DRAG_FACTOR = 0.3;
  // "loose" controls
  // private final static double TERMINAL_VELOCITY = 4.0;
  ...
  public final static double BULLET_SPEED = 50 * 12.0;
  public final static double PLAYER_RADIUS = 30.0;
  ...
  public final static GamePosn STARTING_POSITION = new GamePosn(WIDTH / 2.0, HEIGHT / 2.0); //
  // Potentially we wanna
